...
const config = {
    endpoint: process.env.REACT_APP_APPWRITE_ENDPOINT, projectId: process.env.REACT_APP_APPWRITE_PROJECT_ID, databaseId: process.env.REACT_APP_APPWRITE_DATABASE_ID, userCollectionId: process.env.REACT_APP_APPWRITE_USER_COLLECTION_ID, htmlCollectionId: process.env.REACT_APP_APPWRITE_HTML_COLLECTION_ID, storageId: process.env.REACT_APP_APPWRITE_STORAGE_ID
};
/* export const config = {
